...
export default function WhyChooseUs() {
  ...
  return (
    <div className="bg-gray-100 py-12 dark:bg-gray-800 px-4 lg:px-10">
      <h2 className="text-2xl md:text-4xl font-bold text-center text-gray-800 dark:text-white mb-4">
        Your Game, Our Passion
      </h2>
      <p className="text-lg text-gray-600 dark:text-gray-300 text-center max-w-2xl mx-auto mb-10">
        At PlayGear, we’re committed to empowering athletes with top-notch
        sports gear and exceptional support. Choose us for quality, reliability,
