...
export default function FeaturedEquipCard({ product }) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-xl text-center flex flex-col dark:bg-gray-800 dark:text-white">
      <img
        src={product.image}
      ...
      <p className="text-gray-600 mb-2 dark:text-gray-300 text-sm leading-relaxed">{product.description}</p>
